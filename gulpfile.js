...
const fonts = () => {
  ...
  return src("src/fonts/**/*.ttf").pipe(ttfToWoff2()).pipe(dest("dist/fonts"));
};
...
watch(["src/img/**/*.jpg", "src/img/**/*.png", "src/img/**/*.jpeg"], images);
...
exports.default = series(
  clean,
  parallel(html, scripts, fonts, resources, images, svgSprites),
  fontsStyle,
  styles,
  watchFiles
);
...
exports.build = series(
  clean,
  parallel(htmlBuild, scriptsBuild, fonts, resources, imagesBuild, svgSprites),
  fontsStyle,
  stylesBuild,
  watchFiles
);
